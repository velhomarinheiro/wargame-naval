...
|---|---|---|---|---|
| Reais — decididas (n=7) | 100.0% / 0.0% | 24.6 / 82.8 | 13.0 / 9.5 | 3.29 |
...
- Nas partidas **reais**, 7/7 desfechos foram por **objetivo de cenário** (0% timeout), com duração média de **3.29 turnos**.
...
- Reais: Red causa **82.8** vs Blue **24.6** HP/partida (**3.4×**).
...
|---|---|---|
| 1º | RED-GE-1 (247.0 HP, 26 ab.) | RED-GE-1 (19.38 HP/jogo, 2.13 ab./jogo) |
| 2º | RED-KSN (145.0 HP, 19 ab.) | RED-GE-2 (14.06 HP/jogo, 1.42 ab./jogo) |
| 3º | RED-GE-2 (59.0 HP, 5 ab.) | RED-KS-1 (10.17 HP/jogo, 1.01 ab./jogo) |

...
|---|---|---|---|---|
| Reais — decididas (n=12) | 91.7% / 8.3% | 28.8 / 76.1 | 12.85 / 9.54 | 3.33 |
...
- Nas partidas **reais**, 12/12 desfechos foram por **objetivo de cenário** (0% timeout), com duração média de **3.33 turnos**.
...
- **Reais decididas:** Blue 91.7% × Red 8.3%.
...
- Reais: Red causa **76.1** vs Blue **28.8** HP/partida (**2.6×**).
...
|---|---|---|
| 1º | RED-GE-1 (341.0 HP, 37 ab.) | RED-GE-1 (9.81 HP/jogo, 0.91 ab./jogo) |
| 2º | RED-KSN (234.0 HP, 28 ab.) | RED-GE-2 (8.78 HP/jogo, 0.81 ab./jogo) |
| 3º | RED-GE-2 (112.0 HP, 10 ab.) | RED-KSN (8.34 HP/jogo, 0.42 ab./jogo) |

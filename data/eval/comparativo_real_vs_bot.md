...
|---|---|---|---|---|
| Reais — decididas (n=6) | 100.0% / 0.0% | 21.7 / 74.6 | 11.29 / 9.29 | 2.67 |
...
- Nas partidas **reais**, 6/6 desfechos foram por **objetivo de cenário** (0% timeout), com duração média de **2.67 turnos**.
...
- Reais: Red causa **74.6** vs Blue **21.7** HP/partida (**3.4×**).
...
|---|---|---|
| 1º | RED-GE-1 (199.0 HP, 18 ab.) | RED-GE-1 (19.38 HP/jogo, 2.13 ab./jogo) |
| 2º | RED-KSN (122.0 HP, 15 ab.) | RED-GE-2 (14.06 HP/jogo, 1.42 ab./jogo) |
| 3º | RED-SEOP-2 (50.0 HP, 7 ab.) | RED-KS-1 (10.17 HP/jogo, 1.01 ab./jogo) |

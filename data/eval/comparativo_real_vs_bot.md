...
|---|---|---|---|---|
| Reais — decididas (n=14) | 85.7% / 14.3% | 29.2 / 75.7 | 12.53 / 9.27 | 3.29 |
...
- Nas partidas **reais**, 14/14 desfechos foram por **objetivo de cenário** (0% timeout), com duração média de **3.29 turnos**.
...
- **Reais decididas:** Blue 85.7% × Red 14.3%.
...
- Reais: Red causa **75.7** vs Blue **29.2** HP/partida (**2.6×**).
...
|---|---|---|
| 1º | RED-GE-1 (380.0 HP, 40 ab.) | RED-GE-1 (9.81 HP/jogo, 0.91 ab./jogo) |
| 2º | RED-KSN (288.0 HP, 33 ab.) | RED-GE-2 (8.78 HP/jogo, 0.81 ab./jogo) |
| 3º | RED-GE-2 (121.0 HP, 12 ab.) | RED-KSN (8.34 HP/jogo, 0.42 ab./jogo) |

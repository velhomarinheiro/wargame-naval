...
|---|---|---|---|---|
| Reais — decididas (n=10) | 100.0% / 0.0% | 28.5 / 75.6 | 12.73 / 9.27 | 3.3 |
...
- Nas partidas **reais**, 10/10 desfechos foram por **objetivo de cenário** (0% timeout), com duração média de **3.3 turnos**.
...
- Reais: Red causa **75.6** vs Blue **28.5** HP/partida (**2.7×**).
...
|---|---|---|
| 1º | RED-GE-1 (296.0 HP, 32 ab.) | RED-GE-1 (9.81 HP/jogo, 0.91 ab./jogo) |
| 2º | RED-KSN (167.0 HP, 19 ab.) | RED-GE-2 (8.78 HP/jogo, 0.81 ab./jogo) |
| 3º | RED-GE-2 (105.0 HP, 10 ab.) | RED-KSN (8.34 HP/jogo, 0.42 ab./jogo) |
